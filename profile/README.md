...
The instructions to install and run the [dashboard](https://github.com/langur-treehacks/langur), [extension](https://github.com/langur-treehacks/langur-ext) and [LLM backend](https://github.com/langur-treehacks/llm) are in their individual repos.
